var Chart=function(s){
	...
	function x(a,c,b,e){
		function h(){
			...
			e.clearRect(0,0,q,u);a.scaleOverlay?(b(k),c()):(c(),b(k));
			if(1>=g)D(h);
...
function y(a,c){
	...
	var r=this,B={linear:function(a){return a},easeInQuad:function(a){
		return a*a
									...
									easeOutCirc:function(a){
										...
										this.PolarArea=function(a,c){
											...
											var G=function(a,c,b){
												...
												k=g/j.steps;x(c,
													function(){
														for(var a=0;a<j.steps;a++)if(c.scaleShowLine&&(b.beginPath(),
														...
														if(c.scaleShowLabelBackdrop){
															...
															b.rect(Math.round(q/2-d/2-c.scaleBackdropPaddingX),
																Math.round(u/2-k*(a+1)-0.5*c.scaleFontSize-c.scaleBackdropPaddingY),
														...
														function(e){var d=-Math.PI/2,g=2*Math.PI/a.length,f=1,h=1;c.animation&&(c.animateScale&&(f=e),c.animateRotate&&(h=e));for(e=0;e<a.length;e++)b.beginPath(),b.arc(q/2,u/2,f*v(a[e].value,j,k),d,d+h*g,!1),b.lineTo(q/2,u/2),b.closePath(),b.fillStyle=a[e].color,b.fill(),
